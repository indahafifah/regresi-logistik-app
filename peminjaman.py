...
df_train["Status Anggota"] = df_train["Status Anggota"].map({"Anggota Biasa": 1, "Anggota Luar Biasa": 0})
...
df_test["Status Anggota"] = df_test["Status Anggota"].map({"Anggota Biasa": 1, "Anggota Luar Biasa": 0})
